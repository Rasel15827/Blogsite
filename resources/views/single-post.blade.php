@extends('singleLayout')
@section('body')

<div id="fh5co-title-box" style="background-image: url({{$post->image}}); background-position: 50% 90.5px;" data-stellar-background-ratio="0.5">
    <div class="overlay"></div>
    <div class="page-title">
        <img src="{{asset('assets/images/person_1.jpg')}}" alt="Free HTML5 by FreeHTMl5.co">
