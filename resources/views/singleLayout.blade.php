    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-3 fh5co_padding_menu">
                <img src="{{asset('assets/images/logo.png')}}" alt="img" class="fh5co_logo_width"/>
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="{{route('home.display')}}">Home <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link" href="{{route('blog.display')}}">Blog <span class="sr-only">(current)</span></a>
                    </li>
                    ...
                    <li class="nav-item ">
                        <a class="nav-link" href="{{route('contact.display')}}">Contact <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link" href="{{ route('login') }}">Log In <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item ">
                        <a class="nav-link" href="{{ route('register') }}">Sing Up<span class="sr-only">(current)</span></a>
                    </li>
                </ul>
            </div>
        </nav>
...
<div class="container-fluid fh5co_footer_bg pb-3">
    <div class="container animate-box">
        <div class="row">
            <div class="col-12 spdp_right py-5"><img src="{{asset('assets/images/white_logo.png')}}" alt="img" class="footer_logo"/></div>
            <div class="clearfix"></div>
            ...
            <div class="col-12 col-md-12 col-lg-4 ">
                ...
                <a href="#" class="footer_img_post_6"><img src="{{asset('assets/images/allef-vinicius-108153.jpg')}}" alt="img"/></a>
                <a href="#" class="footer_img_post_6"><img src="{{asset('assets/images/32-450x260.jpg')}}" alt="img"/></a>
                <a href="#" class="footer_img_post_6"><img src="{{asset('assets/images/download (1).jpg')}}" alt="img"/></a>
                <a href="#" class="footer_img_post_6"><img src="{{asset('assets/images/science-578x362.jpg')}}" alt="img"/></a>
                <a href="#" class="footer_img_post_6"><img src="{{asset('assets/images/vil-son-35490.jpg')}}" alt="img"/></a>
                <a href="#" class="footer_img_post_6"><img src="{{asset('assets/images/zack-minor-15104.jpg')}}" alt="img"/></a>
                <a href="#" class="footer_img_post_6"><img src="{{asset('assets/images/download.jpg')}}" alt="img"/></a>
                <a href="#" class="footer_img_post_6"><img src="{{asset('assets/images/download (2).jpg')}}" alt="img"/></a>
                <a href="#" class="footer_img_post_6"><img src="{{asset('assets/images/ryan-moreno-98837.jpg')}}" alt="img"/></a>
            </div>
        </div>
